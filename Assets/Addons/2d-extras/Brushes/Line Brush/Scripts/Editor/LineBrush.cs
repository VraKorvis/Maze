...
namespace UnityEditor {
    ...
    public class LineBrush : GridBrush {
        public bool lineStartDefaultGameObjectInjectionWorld = false;
        public bool fillGaps = false;
        public Vector3Int lineStart = Vector3Int.zero;

        public override void Paint(GridLayout grid, GameObject brushTarget, Vector3Int position) {
            if (lineStartDefaultGameObjectInjectionWorld) {
                ...
                lineStartDefaultGameObjectInjectionWorld = false;
            }
            else {
                lineStart = position;
                lineStartDefaultGameObjectInjectionWorld = true;
            }
        }
    ...
    public class LineBrushEditor : GridBrushEditor {
        ...
        public override void OnPaintSceneGUI(GridLayout grid, GameObject brushTarget, BoundsInt position,
            ...
            if (lineBrush.lineStartDefaultGameObjectInjectionWorld) {
