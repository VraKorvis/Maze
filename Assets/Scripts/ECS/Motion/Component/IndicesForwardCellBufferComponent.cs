...
[Serializable]
public struct IndicesForwardCellTemp : IComponentData {
    public int indexForwardCell;
...
public class IndicesForwardCellTempComponent : MonoBehaviour, IConvertGameObjectToEntity {
